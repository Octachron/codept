...
Dict.of_list [("Arg",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Arg");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Arg");namespace=["Stdlib"];}}; signature=empty}));
               ...
               ("ArrayLabels",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "ArrayLabels");namespace=["Stdlib"];}};path={name=(Unitname.modulize "ArrayLabels");namespace=["Stdlib"];}}; signature=of_list
                                   [("Floatarray",Sig ({origin=Submodule; signature=empty}))]}));
               ("Atomic",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Atomic");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Atomic");namespace=["Stdlib"];}}; signature=of_list
                              [("Loc",Sig ({origin=Submodule; signature=empty}))]}));
               ...
               ("Char",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Char");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Char");namespace=["Stdlib"];}}; signature=of_list
                            [("Ascii",Sig ({origin=Submodule; signature=empty}))]}));
               ...
               ("Iarray",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Iarray");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Iarray");namespace=["Stdlib"];}}; signature=empty}));
               ...
               ("Pair",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Pair");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Pair");namespace=["Stdlib"];}}; signature=empty}));
               ...
               ("Pqueue",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Pqueue");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Pqueue");namespace=["Stdlib"];}}; signature=
                              (merge 
                              (of_list [("MakeMax",Fun (Some {name=Some "E";signature=Sig (
                              {origin=Submodule; signature=empty})},Sig (
                              {origin=Submodule; signature=empty})));
                              ("MakeMaxPoly",Fun (Some {name=Some "E";signature=Sig (
                              {origin=Submodule; signature=empty})},Sig (
                              {origin=Submodule; signature=empty})));
                              ("MakeMin",Fun (Some {name=Some "E";signature=Sig (
                              {origin=Submodule; signature=empty})},Sig (
                              {origin=Submodule; signature=empty})));
                              ("MakeMinPoly",Fun (Some {name=Some "E";signature=Sig (
                              {origin=Submodule; signature=empty})},Sig (
                              {origin=Submodule; signature=empty})))]) 
                              (of_list_type [("Max",Sig ({origin=Submodule; signature=empty}));
                              ("MaxPoly",Sig ({origin=Submodule; signature=empty}));
                              ("Min",Sig ({origin=Submodule; signature=empty}));
                              ("MinPoly",Sig ({origin=Submodule; signature=empty}));
                              ("OrderedPolyType",Sig ({origin=Submodule; signature=empty}));
                              ("OrderedType",Sig ({origin=Submodule; signature=empty}))])
                               )}));
               ...
               ("Repr",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Repr");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Repr");namespace=["Stdlib"];}}; signature=empty}));
               ("Result",Sig ({origin=Unit {source={source=Special "stdlib"; file={name=(Unitname.modulize "Result");namespace=["Stdlib"];}};path={name=(Unitname.modulize "Result");namespace=["Stdlib"];}}; signature=of_list
                              [("Syntax",Sig ({origin=Submodule; signature=empty}))]}));
