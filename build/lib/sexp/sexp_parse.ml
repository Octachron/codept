...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | EOF
    | ATOM of (
# 1 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
       (string)
...
# 10 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
  ...
  fun _menhir_env _menhir_stack _v ->
    ...
    | R ->
        ...
        | EOF ->
            ...
            let _1 = () in
            let _v : (
# 4 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
      (Sexp.any)
# 72 "lib/sexp/sexp_parse.ml"
            ) = 
# 18 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
                  ( _2 )
...
and _menhir_goto__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState9 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ('freshtv79 * _menhir_state * 'tv_sexp0) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ('freshtv77 * _menhir_state * 'tv_sexp0) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((let ((_menhir_stack, _menhir_s, (_1 : 'tv_sexp0)), _, (_2 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
        let _v : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list = 
# 35 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
             ( _1 :: _2 )
# 105 "lib/sexp/sexp_parse.ml"
         in
        _menhir_goto__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list _menhir_env _menhir_stack _menhir_s _v) : 'freshtv78)) : 'freshtv80)
    | MenhirState7 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ('freshtv87 * _menhir_state) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        match _tok with
        | R ->
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv83 * _menhir_state) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let _menhir_env = _menhir_discard _menhir_env in
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv81 * _menhir_state) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s), _, (_2 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
            let _3 = () in
            let _1 = () in
            let _v : 'tv_sexp0 = 
# 39 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
             ( Any (List (_2)) )
# 126 "lib/sexp/sexp_parse.ml"
        ...
        | _ ->
            ...
            _menhir_env._menhir_error <- true;
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv85 * _menhir_state) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
...
# 141 "lib/sexp/sexp_parse.ml"
        )) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        match _tok with
        | R ->
...
# 172 "lib/sexp/sexp_parse.ml"
                ))), _, (_3 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
                let _5 = () in
                let _4 = () in
                let _1 = () in
                let _v : (
# 7 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
      (Sexp.one_and_many Sexp.t)
# 180 "lib/sexp/sexp_parse.ml"
                ) = 
# 24 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
                    ( Keyed_list (_2,_3) )
...
# 230 "lib/sexp/sexp_parse.ml"
    ...
    | MenhirState18 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ('freshtv123) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        match _tok with
        | R ->
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv119) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let _menhir_env = _menhir_discard _menhir_env in
            let _tok = _menhir_env._menhir_token in
            match _tok with
            | EOF ->
                let (_menhir_env : _menhir_env) = _menhir_env in
                let (_menhir_stack : (('freshtv115) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = Obj.magic _menhir_stack in
                ((let (_menhir_env : _menhir_env) = _menhir_env in
                let (_menhir_stack : (('freshtv113) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = Obj.magic _menhir_stack in
                ((let (_menhir_stack, _, (_2 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
                let _4 = () in
                let _3 = () in
                let _1 = () in
                let _v : (
# 5 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
      (Sexp.many Sexp.t)
# 258 "lib/sexp/sexp_parse.ml"
                ) = 
# 21 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
               ( List( _2 ) )
...
# 287 "lib/sexp/sexp_parse.ml"
            ...
            | _ ->
                ...
                _menhir_env._menhir_error <- true;
                let (_menhir_env : _menhir_env) = _menhir_env in
                let (_menhir_stack : (('freshtv117) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = Obj.magic _menhir_stack in
                ((let (_menhir_stack, _menhir_s, _) = _menhir_stack in
        ...
        | _ ->
            ...
            _menhir_env._menhir_error <- true;
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv121) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let (_menhir_stack, _menhir_s, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s) : 'freshtv122)) : 'freshtv124)
    | MenhirState25 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ('freshtv129) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        match _tok with
        | R ->
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv125) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let _menhir_env = _menhir_discard _menhir_env in
            let _tok = _menhir_env._menhir_token in
            match _tok with
            | ATOM _v ->
        ...
        | _ ->
            ...
            _menhir_env._menhir_error <- true;
            let (_menhir_env : _menhir_env) = _menhir_env in
            let (_menhir_stack : ('freshtv127) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
            ((let (_menhir_stack, _menhir_s, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s) : 'freshtv128)) : 'freshtv130)
    | MenhirState27 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ((('freshtv133) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : ((('freshtv131) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list) = Obj.magic _menhir_stack in
        ((let ((_menhir_stack, _, (_2 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)), _, (_4 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
        let _3 = () in
        let _1 = () in
        let _v : 'tv_list0 = 
# 31 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
...
# 363 "lib/sexp/sexp_parse.ml"
        ))), _, (_2 : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = _menhir_stack in
        let _v : 'tv_list0 = 
# 30 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
...
# 399 "lib/sexp/sexp_parse.ml"
    ...
    | MenhirState27 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
        let (_menhir_stack : (('freshtv63) * _menhir_state * 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list)) = Obj.magic _menhir_stack in
        ((let (_menhir_stack, _menhir_s, _) = _menhir_stack in
...
and _menhir_reduce4 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : 'tv__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list = 
# 34 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
  ( [] )
# 439 "lib/sexp/sexp_parse.ml"
     in
    _menhir_goto__home_akh_ocaml_codept_experimental_lib_sexp_sexp_parse_list _menhir_env _menhir_stack _menhir_s _v
...
# 477 "lib/sexp/sexp_parse.ml"
    ...
    ((let _v : 'tv_sexp0 = 
# 38 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
         ( Any(Atom _1) )
...
# 6 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
      (Sexp.atomic Sexp.t)
...
# 27 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
           ( Atom _1 )
...
# 17 "/home/akh/ocaml/codept-experimental/lib/sexp/sexp_parse.mly"
             ( Any(Atom (_1)) )
...
# 219 "/home/akh/.opam/4.04.1/lib/menhir/standard.mly"
