...
Dict.of_list [M {name="Arg"; origin=Unit {source={source=Special "stdlib"; file=["Arg"]};path=["Arg"]}; args=[]; signature=empty}; 
               M {name="Array"; origin=Unit {source={source=Special "stdlib"; file=["Array"]};path=["Array"]}; args=[]; signature=empty}; 
               M {name="ArrayLabels"; origin=Unit {source={source=Special "stdlib"; file=["ArrayLabels"]};path=["ArrayLabels"]}; args=[]; signature=empty}; 
               ...
               M {name="Pervasives"; origin=Unit {source={source=Special "stdlib"; file=["Pervasives"]};path=["Pervasives"]}; args=[]; signature=of_list 
               ...
               M {name="StdLabels"; origin=Unit {source={source=Special "stdlib"; file=["StdLabels"]};path=["StdLabels"]}; args=[]; signature=of_list 
                 ...
                 M {name="Bytes"; origin=Submodule; args=[]; signature=empty}; 
                 M {name="List"; origin=Submodule; args=[]; signature=empty}; 
                 M {name="String"; origin=Submodule; args=[]; signature=empty}]}; 
